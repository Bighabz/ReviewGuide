  ...
  return (
    <div className="min-h-full" style={{ background: 'var(--background)', color: 'var(--text)' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 pb-24">
        ...
        <div className="space-y-10">
          <Specimen kind="current" note="Previous app/page.tsx — fake-input search button + flat 8-poster grid; categories unreachable from the homepage">
          ...
          <Specimen kind="proposed" note="FrontPage — animated brand logo masthead + real input, Today’s Briefing (topic pages, lead-story hierarchy), The Index (categories on the homepage)">
            <FrontPage />
          </Specimen>
        </div>
