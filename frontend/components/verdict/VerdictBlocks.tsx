 ...
 *   TopPickCard   ← top_pick (backend block previously dropped on the floor)
 */
...
/** Renders the backend's top_pick block (previously had no renderer) as the feature card */
